  ...
  return (
    <>
      ...
      <span className={cn("flex items-center gap-2", classNameFull)}>
        <span className="text-primary flex h-7 w-7 items-center justify-center rounded-lg bg-primary/10">
          <NiSparkle size={18} className="text-primary" />
        </span>
        <span className="font-heading text-text-primary text-xl leading-none tracking-tight">
          EduDoc
        </span>
      </span>
